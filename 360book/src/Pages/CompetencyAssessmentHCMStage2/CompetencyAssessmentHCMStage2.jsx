...
import "./CompetencyAssessmentHCMStage2.css";
...
const CompetencyAssessmentHCMStage2 = () => {
    ...
    const fetchNgayDanhGiaNangLucHCMLan2 = async () => {
        try {
            ...
            const item = response.data.data.find(
                (item) => item.content === "Ngày Đánh Giá Năng Lực - tại Hồ Chí Minh - Đợt 2 2025"
            );
            if (item) {
    ...
    return (
        <>
            ...
            <Navbar />
            <div className="countdown-detail-purple-container">
...
export default CompetencyAssessmentHCMStage2;
