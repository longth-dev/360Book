...
import "./CompetencyAssessmentHNStage1.css";
...
const CompetencyAssessmentHNStage1 = () => {
    ...
    const fetchNgayDanhGiaNangLucHNLan1 = async () => {
        try {
            ...
            const item = response.data.data.find(
                (item) => item.content === "Ngày Đánh Giá Năng Lực - tại Hà Nội - Đợt 1 2025"
            );
            if (item) {
    ...
    return (
        <>
            ...
            <Navbar />
            <div className="countdown-detail-brown-container">
...
export default CompetencyAssessmentHNStage1;
