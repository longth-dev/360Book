    ...
    return (
        <>
            ...
            <div className="exam-info-wrapper">
                <h3 className="exam-info-title">Đếm ngược ngày Thi tốt nghiệp THPT 2025</h3>
                <p className="exam-info-text">
                    Theo thông tin chính thức từ Bộ Giáo dục và Đào tạo, kỳ thi tốt nghiệp THPT 2025 sẽ diễn ra trong 2 ngày: <strong>26/6 và 27/6/2025</strong> trên phạm vi toàn quốc.
                </p>
                <p className="exam-info-text">
                ...
                <p className="exam-info-text"><strong>Chi tiết lịch thi tốt nghiệp THPT 2025:</strong></p>
                <img src={lichthi} alt="Lịch thi tốt nghiệp THPT 2025" className="exam-schedule-image" />

                <p style={{ marginTop: "40px" }}>
                    <strong className="exam-info-title" style={{ color: "#2c3e50" }}> Những điều thí sinh cần lưu ý với khi đi thi tốt nghiệp THPT 2025:</strong>
                </p>
                <p className="exam-info-text">
                ...
                Lịch thi tốt nghiệp THPT 2025 là cột mốc then chốt cho hành trình bước vào cánh cửa đại học. Chuẩn bị tốt – Vượt vũ môn thành công!
